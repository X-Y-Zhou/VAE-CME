...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Birth-Death/Control_topology/after20231210/params_trained_abcd.csv",df)
        mse_min[1] = mse
    end
...
mse_min = [4.934196980850141e-5]

using CSV,DataFrames
df = CSV.read("Birth-Death/Control_topology/after20231210/params_trained_abcd.csv",DataFrame)
