...
@everywhere function f_NN(x,l,m,n,o,k)
    return l*x^m/(n+x^o)+k
end;

@everywhere ab_list = [[0.0025,3],[0.0025,5],[0.0025,10],[0.0025,15],[0.0025,20],
...
@everywhere model = Chain(Dense(N, 10, tanh), Dense(10, 5),x -> exp.(x));
