...
@time for epoch in 1:epochs
    ...
    if mse_1+mse_2<mse_min[1]
        ...
        CSV.write("Bursty/Control_rate/params_ode_rate.csv",df)
...
df = CSV.read("Bursty/Control_rate/params_ode_rate.csv",DataFrame)
params1 = df.params1
...
for i = 0:end_time
    if i < τ
        ...
        exact_sol_extend[1:N+1,i+1] = bursty(N+1,120,a,b)
    end
end
