...
solution_theoty = check_inference([0.0282,3.46,0.25])
SSA_data = vec(readdlm("Control_rate_Inference/Control_tau_fixed_otherrand/Inference_data/set$set/$(width)_$dataset.csv",',')[2:end,:])
