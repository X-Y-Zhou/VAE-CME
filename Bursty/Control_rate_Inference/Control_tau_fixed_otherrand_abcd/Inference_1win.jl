...
print(dataset,"\n")
# SSA_data = readdlm("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_abcd/Inference_data/set$set/$(width)_$dataset.csv",',')[2:end,:]
SSA_data = readdlm("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_abcd/data/set$set/$(width).csv",',')[2:end,:]
...
CSV.write("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_abcd/temp_4.csv",df)