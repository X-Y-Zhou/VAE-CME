...
df = CSV.read("Control_tau_fixed_otherrand_abcd/params_tfo2.csv",DataFrame)
params1 = df.params1
...
print(dataset,"\n")
SSA_data = readdlm("Control_tau_fixed_otherrand_abcd/Inference_data/set$set/$(width)_$dataset.csv",',')[2:end,:]
# SSA_data = readdlm("Control_tau_fixed_otherrand_abcd/Inference_data/set$set/$(width).csv",',')[2:end,:]
...
CSV.write("Control_tau_fixed_otherrand_abcd/infer_two_params/temp_3.csv",df)
