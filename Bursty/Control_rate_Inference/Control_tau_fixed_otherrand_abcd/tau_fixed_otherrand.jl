...
data = readdlm("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_abcd/data/training_data.csv",',')[2:end,:]
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_abcd/params_tfo.csv",df)
        mse_min[1] = mse
    end
