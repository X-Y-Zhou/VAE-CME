...
data = readdlm("Control_rate_Inference/Control_tau_fixed_otherrand_abcd/data/training_data.csv",',')[2:end,:]
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Control_rate_Inference/Control_tau_fixed_otherrand_abcd/params_tfo2.csv",df)
        mse_min[1] = mse
    end
