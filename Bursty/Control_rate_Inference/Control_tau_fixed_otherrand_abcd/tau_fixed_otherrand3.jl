...
data = readdlm("Control_tau_fixed_otherrand_abcd/data/training_data.csv",',')[2:end,:]
...
df = CSV.read("Control_tau_fixed_otherrand_abcd/params_tfo3.csv",DataFrame)
params1 = df.params1
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Control_tau_fixed_otherrand_abcd/params_tfo3.csv",df)
        mse_min[1] = mse
    end
