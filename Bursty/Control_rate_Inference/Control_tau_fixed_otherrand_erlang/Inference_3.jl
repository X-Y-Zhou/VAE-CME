...
df = CSV.read("Control_tau_fixed_otherrand_erlang/params_tfo2.csv",DataFrame)
params1 = df.params1
...
SSA_data = readdlm("Control_tau_fixed_otherrand_erlang/data/set$set/$(width).csv",',')[2:end,:]
...
kinetic_params0 = [0.0232,2.96,0.3230]
