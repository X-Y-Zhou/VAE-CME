...
kinetic_params_all = readdlm("/Users/x-y-zhou/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/infer_set$(set)_$(width)_exact.csv",',')[2:end,:]
...
plot_all()
savefig("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/inference_pre_set$(set)-$width.pdf")
