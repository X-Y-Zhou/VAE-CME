...
data = readdlm("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/data/training_data.csv",',')[2:end,:]
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/params_tfo.csv",df)
        mse_min[1] = mse
    end
...
plot_all()
savefig("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/fitting.png")
...
plot_all()
savefig("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/pre.png")
...
data_Extenicity = []
for a in a_list
    data_temp = Float64.(readdlm("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/data/set$set/$a.csv",',')[2:end,:])
...
plot_all()
savefig("Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_logn/preset$set.png")
