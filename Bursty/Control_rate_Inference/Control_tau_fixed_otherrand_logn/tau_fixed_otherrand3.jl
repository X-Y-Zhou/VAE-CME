...
data = readdlm("Control_tau_fixed_otherrand_logn/data/training_data.csv",',')[2:end,:]
...
lr_list = [0.0008,0.0006]
lr = 0.008;  #lr需要操作一下的
lr_list

for lr in lr_list
using CSV,DataFrames
df = CSV.read("Control_tau_fixed_otherrand_logn/params_tfo3.csv",DataFrame)
params1 = df.params1
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Control_tau_fixed_otherrand_logn/params_tfo3.csv",df)
        mse_min[1] = mse
    end
...
plot_all()
savefig("Control_tau_fixed_otherrand_logn/fitting.png")
...
plot_all()
savefig("Control_tau_fixed_otherrand_logn/pre.png")
...
data_Extenicity = []
for a in a_list
    data_temp = Float64.(readdlm("Control_tau_fixed_otherrand_logn/data/set$set/$a.csv",',')[2:end,:])
...
plot_all()
savefig("Control_tau_fixed_otherrand_logn/preset$set.png")
