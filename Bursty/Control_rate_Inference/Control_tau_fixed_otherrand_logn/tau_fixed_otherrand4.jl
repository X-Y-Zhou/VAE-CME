...
data = readdlm("data/training_data.csv",',')[2:end,:]
...
data_Extenicity = []
for a in a_list
    data_temp = Float64.(readdlm("data/set$set/$a.csv",',')[2:end,:])
