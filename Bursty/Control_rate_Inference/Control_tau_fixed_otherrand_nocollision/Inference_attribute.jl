...
SearchRange = SRange, NumDimensions = 1, MaxSteps = 10) #参数推断求解
...
CSV.write("/Users/x-y-zhou/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/infer_set$(set)_$(width)_exact_a.csv",df)
