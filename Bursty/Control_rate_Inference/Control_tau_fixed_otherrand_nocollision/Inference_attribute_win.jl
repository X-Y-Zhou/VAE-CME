...
df = CSV.read("C:/Users/16037/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/params_tfo.csv",DataFrame)
params1 = df.params1
...
SSA_data = readdlm("C:/Users/16037/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/data/set$set/$(width).csv",',')[2:end,:]

@time for dataset = 1:5
print(dataset,"\n")
# SSA_data = readdlm("C:/Users/16037/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/Inference_data/set$set/$(width)_$dataset.csv",',')[2:end,:]
SSA_data = readdlm("C:/Users/16037/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/data/set$set/$(width).csv",',')[2:end,:]

# kinetic_params0 = [0.0282,3.46,0.667]
SRange = [(0,1)]
res = bboptimize(Objective_func; Method = :adaptive_de_rand_1_bin_radiuslimited, 
SearchRange = SRange, NumDimensions = 1, MaxSteps = 300) #参数推断求解
...
CSV.write("C:/Users/16037/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/infer_set$(set)_$(width)_exact_a.csv",df)
