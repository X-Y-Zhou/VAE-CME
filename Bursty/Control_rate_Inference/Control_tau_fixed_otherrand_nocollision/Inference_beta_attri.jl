...
CSV.write("/Users/x-y-zhou/Documents/GitHub/VAE-CME/Bursty/Control_rate_Inference/Control_tau_fixed_otherrand_nocollision/infer_set$(set)_$(width)_exact_ba.csv",df)
