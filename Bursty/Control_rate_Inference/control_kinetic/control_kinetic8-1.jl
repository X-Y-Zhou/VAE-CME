...
decoder = Chain(Dense(latent_size, 200),Dense(200 , 4),x ->softplus.(x));
...
df = CSV.read("Control_rate_Inference/control_kinetic/params_ck8-3.csv",DataFrame)
params1 = df.params1
...
@time for epoch in 1:epochs
    ...
    if mse<mse_min[1]
        ...
        CSV.write("Control_rate_Inference/control_kinetic/params_ck8-3.csv",df)
        mse_min[1] = mse
    end
