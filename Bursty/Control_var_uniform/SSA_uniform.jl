...
solnet_people = zeros(tmax+1,trajectories)
for i=1:tmax+1
...
df = DataFrame(train_sol_people,:auto)
CSV.write("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/$(round(Int,Dx)).csv",df)

train_sol_1 = readdlm("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/133.csv",',')[2:end,:]
train_sol_2 = readdlm("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/533.csv",',')[2:end,:]
train_sol_3 = readdlm("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/1200.csv",',')[2:end,:]
train_sol_4 = readdlm("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/2133.csv",',')[2:end,:]
train_sol_5 = readdlm("machine-learning/ode/bursty/Controlmean_lognormal/data_uniform/3333.csv",',')[2:end,:]
