...
# plot(p0p1,lw=3,title=join([round.([sigma_on,sigma_off,rho_on],digits=4)]))
...
ps_list = readdlm("Topology/tele/data/ps_telev6.txt")
...
writedlm("Topology/tele/data/matrix_telev6.csv",matrix_tele)
...
for i = 1:10
    p = plot_channel(i)
    savefig(p,"Topology/tele/data/compare/fig_$i.svg")
end
