...
@everywhere ps_matrix_bd = vec(readdlm("Topology/ps_bdv3.csv"))
...
for lr in lr_list
    ...
    @time for epoch in 1:epochs
        ...
        if mse_tele<mse_min[1]
            ...
            CSV.write("Topology/vae/params_trained_vae_tele_bino.csv",df)
            mse_min[1] = mse_tele
        end
        print("mse_bd:",mse_bd,"\n")
    ...
    df = CSV.read("Topology/vae/params_trained_vae_tele_bino.csv",DataFrame)
