# Topology_results/fix_delay/ps_burstyv1.txt
...
τ = 10
N = 120
# writedlm("Topology_results/fix_delay/ps_burstyv1.txt",ps_matrix)
...
for i = 1:5
    p = plot_channel(i)
    savefig(p,"Topology_results/fix_delay/compare/fig_$i.svg")
end