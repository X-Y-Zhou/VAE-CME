...
@everywhere ps_matrix = readdlm("Topology_results/var_delay/result_plus/ps_tele.txt")
...
batchsize
@time matrix_tele = hcat(pmap(set->generate_SSA(set),1:4)...);

writedlm("Topology_results/var_delay/result_plus/tele_SSA_$T1-$(T2).txt",matrix_tele)
