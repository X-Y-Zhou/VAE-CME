...
for j = 1:2
    T1 = T1T2_list[j][1]
    T2 = T1T2_list[j][2]
    ps_matrix = readdlm("Topology_results/var_delay/result_plus/ps_bursty.txt")
...
writedlm("Topology_results/var_delay/result_plus/bursty_SSA_Attr=0.txt",matrix_bursty)

ps_matrix[:,[10,30,40]]
writedlm("Topology_results/var_delay/result_plus/ps_bursty_tmp.txt",ps_matrix[:,[10,30,40]])
...
function plot_distribution(set)
    plot(0:N-1,matrix_bursty_list[1][:,set],linewidth = 3,label="Uniform(10,10)")
