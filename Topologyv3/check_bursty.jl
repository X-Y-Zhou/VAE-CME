...
train_sol1 = readdlm("Topologyv3/bursty_data/matrix_bursty_100-100.csv") # var = 0
train_sol2 = readdlm("Topologyv3/bursty_data/matrix_bursty_0-200.csv") # var = 1

train_sol3 = readdlm("Topologyv3/bursty_data/matrix_bursty_25-175.csv") # var = 0.75
train_sol4 = readdlm("Topologyv3/bursty_data/matrix_bursty_50-150.csv") # var = 0.5
train_sol5 = readdlm("Topologyv3/bursty_data/matrix_bursty_75-125.csv") # var = 0.25
