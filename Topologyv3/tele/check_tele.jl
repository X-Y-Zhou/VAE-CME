...
train_sol1 = readdlm("Topologyv3/bursty_data/matrix_bursty_100-100.csv") # var = 0 Attribute = 0
train_sol2 = readdlm("Topologyv3/bursty_data/matrix_bursty_0-200.csv") # var = max Attribute = 1
