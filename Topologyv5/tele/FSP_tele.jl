...
ps_list = readdlm("Topologyv5/tele/data/ps_telev1.txt")
...
writedlm("Topologyv5/tele/data/matrix_tele_50-50.csv",matrix_tele)
...
for i = 1:4
    p = plot_channel(i)
    savefig(p,"Topologyv5/tele/data/compare/fig_$i.svg")
end
