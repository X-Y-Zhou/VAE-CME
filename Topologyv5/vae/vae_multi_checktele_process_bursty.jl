...
@everywhere ps_matrix_tele = readdlm("Topologyv5/tele/data/ps_telev$version.txt")
...
check_sol1 = readdlm("Topologyv5/tele/data/matrix_tele_50-50.csv") # Attrtibute = 0
# check_sol2 = readdlm("Topologyv5/tele/data/matrix_tele_0-200.csv") # Attrtibute = 1

# check_sol3 = readdlm("Topologyv5/tele/data/matrix_tele_50-150.csv") # Attrtibute = 0.5

# bursty params and train_sol
@everywhere ps_matrix_bursty = readdlm("Topologyv5/ps_burstyv1.csv")
...
train_sol1 = readdlm("Topologyv5/bursty_data/matrix_bursty_50-50.csv") # var = 0
train_sol2 = readdlm("Topologyv5/bursty_data/matrix_bursty_0-100.csv") # var = max
...
for lr in lr_list
    ...
    @time for epoch in 1:epochs
        ...
        if mse_tele<mse_min[1]
            ...
            CSV.write("Topologyv5/vae/params_trained_vae_tele_bursty_better.csv",df)
            mse_min[1] = mse_tele
        end
    ...
    df = CSV.read("Topologyv5/vae/params_trained_vae_tele_bursty_better.csv",DataFrame)
...
for i = 1:4
    p = plot_channel(i)
    savefig(p,"Topologyv5/topo_results/fig_$i.svg")
end
